...
void test_data_pin_input(){TEST_ASSERT_EQUAL(5,DATA_INPUT );}
void test_shift_allower_pin(){TEST_ASSERT_EQUAL(6, SHIFT_ALLOWER);}
void test_writting_allower_pin(){TEST_ASSERT_EQUAL(7, WRITTING_ALLOWER);}
...
void setup(){
  ...
  UNITY_BEGIN();
  RUN_TEST(test_data_pin_input);
  RUN_TEST(test_shift_allower_pin);
  RUN_TEST(test_writting_allower_pin);
}
